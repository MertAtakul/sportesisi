...
<html lang="en">
  ...
  <h4 class="mt-4 mb-3 text-white">Just Sports'a üye ol</h3>
...
<div class="mb-3">
    ...
    <div id="emailHelp" class="form-text text-white">E-mailinizi asla başka birisi ile paylaşmayacağız.</div>
  </div>
  ...
  <button type="submit" class="btn btn-primary text-white">Üye ol</button>
</form>
</main>
